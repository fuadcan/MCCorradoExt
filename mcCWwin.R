# Tm=100;n=20;clsize=3; frho=.2; ind=17; noCons=T
#########################
...
mcCW <- function(Tm,n,clsize,frho,noCons){
  ...
  RtoGauss <- function(crit=.05){
    script <- paste0("cd C:\\Users\\Thanasis\\Documents\\MCCorradoExt\\CLUSTERB && C:\\gauss10\\tgauss -o -b -e stopval=",crit,";rown=",Tm,";coln=",n,";RUN MONTECARLOB",datind,".GSS")
    tempCW <- shell(script, intern=TRUE,wait=TRUE)
