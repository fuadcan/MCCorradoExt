...
####### MULTI CLUB CASE ########
mcAplus(50,10,2,.2,T,F)
mcAplus(100,10,2,.2,T,F)
mcAplus(50,10,2,.6,T,F)
mcAplus(100,10,2,.6,T,F)
# with constant
mcAplus(50,10,2,.2,F,F)
mcAplus(100,10,2,.2,F,F)
mcAplus(50,10,2,.6,F,F)
mcAplus(100,10,2,.6,F,F)
# m=3
mcAplus(50,10,3,.2,T,F)
mcAplus(50,10,3,.6,T,F)
mcAplus(100,10,3,.2,T,F)
mcAplus(100,10,3,.6,T,F)
# with constant
mcAplus(50,10,3,.2,F,F)
